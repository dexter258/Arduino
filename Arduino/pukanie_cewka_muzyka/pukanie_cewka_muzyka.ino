...
const int threshold = 18;           // Minimum signal from the piezo to register as a knock
const int rejectValue = 80;        // If an individual knock is off by this percentage of a knock we don't unlock..
const int averageRejectValue = 65; // If the average timing of the knocks is off by this percent we don't unlock.
