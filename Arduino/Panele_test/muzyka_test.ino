...
for (int i=0;i<29;i++){
  ...
  if ((lvl==2)&&(wcisniety[4]==0)&&(suma>0)) lvl=0;
  if ((lvl==3)&&(wcisniety[22]==0)&&(suma>0)) lvl=0;
    if ((lvl==4)&&(wcisniety[19]==0)&&(suma>0)) lvl=0;
        if ((lvl==5)&&(wcisniety[7]==0)&&(suma>0)) lvl=0;
if (wcisniety[28]==1){
  lvl=1;
}
  if ((lvl==1)&&(wcisniety[1]==1)){
    ...
    if ((lvl==2)&&(wcisniety[4]==1)){
    lvl=3;
  }
      if ((lvl==3)&&(wcisniety[22]==1)){
    lvl=4;
  }
        if ((lvl==4)&&(wcisniety[19]==1)){
    lvl=5;
  }
          if ((lvl==5)&&(wcisniety[7]==1)){
    lvl=6;
  }
