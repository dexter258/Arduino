...
#define NOTE_B1  62
#define NOTE_C2  65
#define NOTE_Cs2[i] 69
#define NOTE_D2  73
#define NOTE_Ds2[i] 78
#define NOTE_E2  82
#define NOTE_F2  87
#define NOTE_Fs2[i] 93
#define NOTE_G2  98
#define NOTE_Gs2[i] 104
#define NOTE_A2  110
#define NOTE_As2[i] 117
#define NOTE_B2  123
#define NOTE_C3  131
#define NOTE_Cs3[i] 139
#define NOTE_D3  147
#define NOTE_Ds3[i] 156
#define NOTE_E3  165
#define NOTE_F3  175
#define NOTE_Fs3[i] 185
#define NOTE_G3  196
#define NOTE_Gs3[i] 208
#define NOTE_A3  220
#define NOTE_As3[i] 233
#define NOTE_B3  247
#define NOTE_C4  262
#define NOTE_CS4 277
#define NOTE_D4  294
...
#define przewody_1 A1
#define przewody_2 A2

#define wersja_angielska A0
int k=4;
...
void loop() {
  ...
  if (analogRead(wersja_angielska)>800) 
  {
  ang=1;
  //Serial.println("WERSJA ANGIELSKA");
  }
  
  
   // ODCZYTYWANIE WARTOŚCI POSZSCZEGÓLNYCH KOLORÓW PRZEZ ZASTOSOWANIE ODPOWIEDNICH FILTRÓW CZYTNIKA KOLORÓW
     if ((analogRead(przewody_1)>800) && (analogRead(przewody_2)>800))
  {
   ...
   //  Serial.println("PODLACZONO PRZEWODY");
    start=1;
   }
  }
  if (start==1)
  ...
  //    Serial.println("NAPIS BRAK PALIWA");
    ...
    //     Serial.println("USTAWIENIE  SERW");
         delay(1000);
  ...
  //  Serial.println("ROZPOCZECIE BADANIE KOLOROW:");
    }
    for (int i=0;i<3;i++)
           {
 ...
 for (int i=0;i<3;i++)
   ...
   */
     ...
     if (gColorStrength[0]==255 && bColorStrength[1]==255)
     {   
         lcd.clear();
